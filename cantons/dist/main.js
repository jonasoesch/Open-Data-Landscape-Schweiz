...
d3.json('cantons.data.json', function (err, cantons) {
    ...
    function opendata() {
        svg.selectAll("#cantons polygon, #cantons path")
            .attr('fill', function () { return colorscheme[cantons['cantons'][this.id]['opendata']]; });
...
function legend(colors, texts) {
    ...
    var legend = d3.select('#cantons')
        .append('g')
        .attr('class', 'legend');
    function legendPosition(i, shift) {
    ...
    legend.selectAll('rect')
        ...
        .attr('height', 10)
        .attr('x', '0px')
        .attr('y', function (d, i) { return legendPosition(i); })
    ...
    legend.selectAll('text')
        ...
        .append('text')
        .attr('x', '20px')
        .attr('y', function (d, i) { return legendPosition(i, 10); })
        .attr('fill', '#333')
        .attr('font-family', 'sans-serif')
