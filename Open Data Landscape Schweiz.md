# Open Governement Data Landscape Schweiz
...
Der freie Zugang zu Forschungsdaten stellt in der Schweiz ein erstaunlich grosses Problem dar. Zwar haben die grossen Hochschulen bereits 2006 ihre Absicht erklärt, ihre Rohdaten unter dem Label «Open Access» offen zu publizieren. Zwar sind seither immer mehr Publikationen frei zugänglich, die erhobenen Daten werden aber weiterhin nicht mitveröffentlicht. Der Schweizerische Nationalfonds hat darauf reagiert und verlangt für geförderte Projekte ab Ende Jahr einen Data Management Plan. Offene Forschungsdaten stehen damit in der Schweiz absolut am Anfang. Wie sieht es mit den Daten aus der Verwaltung aus?

Die Bundesverwaltung ist seit dem Inkrafttreten des Öffentlichkeitsgesetzes 2006 verpflichtet den Grossteil ihrer Daten auf Anfrage zur Verfügung zu stellen. Ähnliche Gesetzgebungen [existieren in den meisten Kantonen](https://www.oeffentlichkeitsgesetz.ch/deutsch/die-kantone/). Für Daten die viel genutzt werden, wäre eine Publikation als Open Data schon nur logisch, um sich das mehrfache Beantworten von Anfragen zu ersparen. Es kommt hinzu, dass sich durch die Öffnung der Daten eine hohe Wertschöpfung von rund einer Milliarde Franken pro Jahr ergeben würde.[^buergi] 

Trotzdem brauchte es noch einige Jahre, bis der Bund 2014 eine nationale Open Governement Data-Strategie verabschiedete. Eine Teil dieser Strategie ist die Einführung einer zentralen Stelle für offene Behördendaten: opendata.swiss.
...
In dieser Übersicht wird auch deutlich, welche der 35 aufgeführten Organisationen effektiv am meisten Daten beisteuern. Als Metrik wurden in diesem Fall die Anzahl Felder in einem Datensatz genommen.
...
[Exkurs zu Linked Data]

Linked Data vereinfacht die Verknüpfung von Datensätzen aus verschiedenen Städten, Kantonen, vor allem aber aus verschiedenen Ländern. Die selbe Verknüpfung ist aber im Prinzip auch möglich, wenn zwischen den Datenlieferanten ein Einverständnis über das Datenformat herrscht. Ein faszinierendes Beispiel dazu ist die Applikation [Rome2Rio](https://www.rome2rio.com) die GTFS-Transportdaten verschiedenster Transportunternehmen kombiniert um weltweit Routenvorschläge für den öffentlichen Verkehr zu machen und damit teilweise qualitativ sogar Google übertrifft.


## Fazit

Es ist ein Widerspruch zwischen dem Funktionieren des Verwaltungsapparats der klare Weisungen erwartet und der aktivistischen Idee von offenen Daten als Standard. Es ist darum umso erstaunlicher, dass die Idee überhaupt in der Verwaltung und in der Verwaltung sogar noch vor den wisschenschaftlichen Einrichtungen Fuss fassen konnte. Auch die Kantone gehen mehr und mehr dazu über, ihre Daten öffentlich zu machen. So haben *mehr als die Hälfte* der Kantone zumindest schon einen Open Data-Strategie und ein Viertel veröffentlicht bereits Daten mit einer freien Lizenz. Das mag für die hochmotivierten Open Data-Aktivisten frustrierend langsam sein, und trotzdem ist es ein Erfolg. Denn an ein zurück ist schwer zu denken. So sagt auch Juan-Pablo Lovato: "Die Zeit arbeitet für uns. Irgendwann wird es selbstverständlich sein, dass Behördendaten frei zugänglich sind."


[^schlauri]: http://www.digitale-nachhaltigkeit.unibe.ch/unibe/portal/fak_wiso/a_bwl/inst_wi/abt_digital/content/e90958/e490158/e500681/e500852/rightcol550749/OpenDataVorlesung2017_Termin05_GastreferatSchlauri_ger.pdf

[^buergi]: https://www.egovernment.ch/de/umsetzung/e-government-schweiz-2008-2015/open-government-data-schweiz/
