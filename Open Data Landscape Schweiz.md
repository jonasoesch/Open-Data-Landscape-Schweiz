...
Solche Daten dürfen beliebig vervielfältigt, weitergegeben und kopiert werden. "Es ist oftmals kaum mehr nachzuvollziehbar, wer, welche Datensätze nutzt.", sagt JuanPablo Lovato, Projektleiter Open Government Data Schweiz. "Aber das liegt in der Natur des Sache".

Dass die Sache überhaupt auf den Radar des Bundesrates kam, dafür ist nicht zuletzt der 2011 gegründete [Verein opendata.ch](https://opendata.ch/) verantwortlich. Die Aktivisten des Vereins sind gut vernetzt in Politik, Medien und der IT-Branche. So rangieren sie auf Twitter  mit fast [5000 Followern](https://twitter.com/opendatach) weit vor ähnliche Lobbyorganisationen wie [swissICT](https://twitter.com/swissict) oder [Energie Schweiz](https://twitter.com/energieschweiz). Die Community ist sehr lebendig und Twitter ist das Medium der Wahl. Der Verein betont zwar immer wieder den wirtschaftlichen Nutzen von offenen Daten (geschätzt auf bis zu einer Milliarde Franken pro Jahr); trotzdem sind seine Mitglieder aber vor allem Idealisten.

Dieser Eindruck bestätigt sich als ich Oleg Lavrovsky, den "Crowdsourcing Champion" des Vereins, im [Kaffee Effinger](https://www.effinger.ch/) in Bern treffe. Aus dem geplanten Interview wird bald eine Grundatzdiskussion. Lavrovsky sieht offene Daten in Zukunft als unverzichtbaren Teil unserer Infrastruktur. Wie Wasser oder Strom.
...
Nach Möglichkeit geschieht dies automatisch mittels sogenannter "Harvester". Die Stadt Zürich, ein Vorreiter in Sachen Open Governement Data, hat so zum Beispiel ihre eigene Plattform mit opendata.swiss verknüpft. Täglich werden die neue und aktualisierte Datensätze ohne menschliches Zutun auf den neusten Stand gebracht.

"Das ist genau der Charme von Open Data", bestätigen mir Marco Sieber und Reto Wick, die OGD-Beauftrageten der Stadt Zürich. "dass wir die Daten schon haben. Wir brauchen sie nur noch in geeigneter Form zu publizieren. Das kann man auch automatisieren". Auch der Bundesrat erwähnt diese Sekundärnutzung als eine der Stärken von Open Data. 

Dass das nicht immer so einfach ist, wissen die beiden selbst am besten. Seit 2012 werben sie an den verschiedenen Stellen dafür, dass sie ihre Daten "per default" offenlegen. Oft steht oder fällt es damit, ob sich die richtige Person an der entsprechenden Stelle [für das Thema interessiert](https://www.stadt-zuerich.ch/content/dam/stzh/portal/Deutsch/OGD/Dokumente/Hinderungsgr%c3%bcnde%20f%c3%bcr%20Open%20Government%20Data.pdf). 

Jemand der sich dafür interessiert ist Daniel Schweizer von den Parlamentsdiensten. Um Informationen über die Parlamentarier, Vorlagen und Abstimmungsresultate auf [parlament.ch](https://www.parlament.ch/de) darzustellen, nutzen sie selbst eine Daten-API. Diese öffentlich zu machen, war für die Parlamentsdienste dann nur noch ein kleiner Schritt. Neben der aufbereiteten Form auf der Webseite des Bundeshauses oder gedruckt im amtlichen Bulletin, hat der Nutzer so auch Zugang zu den "nackten Daten".
...
So präsentiert sich mir hier ein Haufen Antworten ohne die zugehörigen Fragen. Es liegt nun wohl an mir, meine eigene Frage an die Daten zu stellen. Ich fange damit an: "Wie viel Daten sind den überhaupt 2408 Datensätze?"
